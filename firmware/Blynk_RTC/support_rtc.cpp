...
void RTC::saveAlarmTime(const uint8_t index, const char* value) {
  Alarm_ID = index;
  Alarm.LampTimesAry[index-1] = value;
  
}

/* gets the Alarm time in %02d:%02d:%02d format as String */
...
/************************ Set the ON Time for the cleaner **************************/
void RTC::setAlarmA1(void) {
	...
	snprintf(log, sizeof(log), "The Alrm Time for A1 is = %02d:%02d:%02d", wake_HOUR, wake_MINUTE, wake_SECOND);
	Serial.println(log);
...
/************************ Set the OFF Time for the cleaner **************************/
void RTC::setAlarmA2(void) {
	...
	snprintf(log, sizeof(log), "The Alrm Time for A2 is = %02d:%02d:%02d", wake_HOUR, wake_MINUTE, wake_SECOND);
	Serial.println(log);
...
/*****************************************************************************
Function description : sets the Time on DS3231 when the Device first boots up
